...
/**
 * Tripo AI 图像生成3D模型请求
 * 根据官方文档: https://platform.tripo3d.ai/docs/generation#image-to-model
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class TripoImageToModelRequest extends TripoTaskRequest {
    
    /**
     * 文件信息 (必需)
     * 指定图像输入，分辨率必须在20px到6000px之间，建议分辨率大于256px
     */
    ...
    /**
     * 方向 (可选)
     * 设置orientation=align_image自动旋转模型以对齐原始图像
     * 默认值: default
     */
    ...
    public TripoImageToModelRequest() {
        setType("image_to_model");
    }
    ...
    public static class TripoFileInfo {
        /**
         * 文件类型
         * 虽然目前不验证，但强烈建议指定正确的文件类型
         */
        private String type;
        
        /**
         * 文件令牌
         * 从上传获得的标识符，与url和object互斥
         */
        ...
        /**
         * 图像的直接URL
         * 支持JPEG和PNG格式，最大20MB，与file_token和object互斥
         */
        private String url;
